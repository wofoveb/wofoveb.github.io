	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a rel="external nofollow" href="http://www.arnebrachhold.de/redir/sitemap-home/" title="Google (XML) Sitemap Generator">Google (XML) Sitemaps Generator</a>. This XSLT template is released under the GPL and free to use.<br />
				</div>
			</body>
		</html>
	</xsl:template>
